		...
		<div className="h-full w-1/2">
			...
			<form className="grid h-auto place-items-center " onSubmit={submit}>
				...
				<div className="w-9/12 my-4 flex justify-between">
					<label htmlFor="checkbox" className="text-white mx-2">
						Task is done ?
					</label>
					<input
						type="checkbox"
				...
				<input
					type="submit"
					className="select-none rounded-lg bg-black mt-10 px-60 py-4 font-bold text-white dark:bg-white dark:text-black"
				/>
			</form>
		</div>
	)
